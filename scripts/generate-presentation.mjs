...
h1 { font-size: 72px; font-weight: 800; letter-spacing: -0.02em; margin-bottom: 8px; }
h2 { font-size: 40px; font-weight: 700; }
h3 { font-size: 20px; font-weight: 700; }
p { line-height: 1.5; }
.subtitle { font-size: 28px; color: var(--primary); margin-bottom: 6px; }
.laws { font-size: 16px; color: var(--muted); max-width: 900px; margin: 0 auto 24px; text-align: center; }
.badge { display: inline-block; padding: 8px 20px; border: 1px solid #F0B90B40; border-radius: 24px; color: var(--primary); font-size: 16px; }
...
.cta-desc { font-size: 22px; color: var(--muted); max-width: 900px; margin: 0 auto 28px; }
...
.cta-footer { font-size: 16px; color: #555; }
